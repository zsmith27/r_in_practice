...
1.	Create a new repository online on your GitHub account (https://github.com/)
...
When working in R Studio with GitHub, use the dropdown menu (located in the top right corner of the Git tab in the Environment pane) to select the branch you want to work on. In the image below I clicked on “master” and now I can see three branches are available for this project: 1) master, 2) Development, and 3) Zsmith. Simply select a name to change the branch you are working on.
